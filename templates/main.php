<?php
vendor_script('blendmaxmayaplugingui', array('paging' , 'list.min' ));
script('blendmaxmayaplugingui', 'script');
style('blendmaxmayaplugingui', array('bootstrap', 'font-awesome.min', 'style'));
?>
